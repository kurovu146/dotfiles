...
return {
  ...
  -- add tsserver and setup with typescript.nvim instead of lspconfig
  {
    ...
    opts = {
      servers = {
        -- tsserver will be automatically installed with mason and loaded with
        -- lspconfig
        tsserver = {},
      },
  ...
  -- for typescript, LazyVim also includes extra specs to properly setup
  -- lspconfig,
  -- treesitter, mason and typescript.nvim. So instead of the above, you can
  -- use:
  ...
  -- since `vim.tbl_deep_extend`, can only merge tables and not lists, the code
  -- above
